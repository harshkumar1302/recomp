...
export const FOOD_DB = {
  ...
  lettuce:          { name: 'Lettuce', unit: 'g', p: 1.4, c: 2.9, f: 0.2, kcal: 15, baseQty: 100, keys: ['lettuce', 'lectus', 'salad patta', 'iceberg', 'romaine'] },
  coriander:        { name: 'Coriander / Cilantro', unit: 'g', p: 2.1, c: 3.7, f: 0.5, kcal: 23, baseQty: 100, keys: ['coriander', 'cilantro', 'dhaniya', 'dhania', 'coriander leaves'] },
  mint:             { name: 'Mint / Pudina', unit: 'g', p: 3.3, c: 14.9, f: 0.7, kcal: 70, baseQty: 100, keys: ['mint', 'pudina', 'mint leaves'] },
